...
<div class="admin-card" style="max-width: 600px;">
    <form action="{{ route('admin.faqs.store') }}" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <input type="text" name="question" class="form-control" placeholder="What is your return policy?" required>
        </div>
        <div class="form-group" style="margin-bottom: 30px;">
            <label style="display: block; margin-bottom: 8px; font-weight: 700;">Answer</label>
            <textarea name="answer" class="form-control" rows="6" placeholder="Enter detailed answer here..." required></textarea>
        </div>
        <div style="display: flex; gap: 15px;">
            <button type="submit" class="btn-admin btn-primary" style="padding: 15px 40px; border-radius: 10px; font-size: 1rem; cursor: pointer;">Save FAQ</button>
