...
@section('content')
            ...
            <section class="hero" style="min-height: 80vh; display: flex; align-items: center; position: relative;">
                <div class="container">
                    <div style="display: flex; align-items: center; gap: 50px; flex-wrap: wrap;" class="flex-responsive">
                        <div style="flex: 1; min-width: 300px; z-index: 2;" class="mobile-100">
                            <span
                                style="display: inline-block; padding: 6px 15px; background: rgba(212, 175, 55, 0.1); border: 1px solid var(--primary-color); color: var(--primary-color); border-radius: 50px; font-weight: 700; font-size: 0.8rem; margin-bottom: 20px; text-transform: uppercase; letter-spacing: 2px;">
                            ...
                            <div style="display: flex; gap: 20px;">
                                <a href="{{ route('products.index') }}" class="btn btn-primary"
                                    style="padding: 15px 35px; background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); box-shadow: 0 10px 30px var(--accent-glow);">Launch Creator</a>
                                <a href="{{ route('products.index') }}" class="btn glass"
                                    style="padding: 15px 35px; border: 1px solid var(--accent-color); color: var(--black);">View
                                    Drops</a>
                            </div>
                        </div>
                        <div style="flex: 1; min-width: 300px; position: relative;" class="mobile-100">
                            <div
                                style="position: absolute; inset: 0; background: radial-gradient(circle, var(--primary-color) 0%, transparent 70%); filter: blur(60px); opacity: 0.2; transform: scale(1.2);">
                            </div>
                            <img src="{{ asset('images/hero-hitech.png') }}" alt="High-Tech Customization"
                                style="width: 100%; filter: drop-shadow(0 0 30px rgba(212, 175, 55, 0.4)) sepia(1) hue-rotate(-15deg) saturate(2); animation: float 6s ease-in-out infinite;">
                        </div>
                    </div>
                </div>
            </section>
    ...
    <section class="section reveal" style="background: var(--bg-alt); position: relative;">
        <div class="container">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
                <!-- Feature 1 -->
                <div class="glass"
                    style="padding: 40px; border-radius: 30px; position: relative; overflow: hidden; transition: var(--transition); border: 1px solid rgba(212, 175, 55, 0.2);">
                    <span
                        style="position: absolute; top: 10px; right: 20px; font-size: 4rem; font-weight: 900; color: rgba(255,255,255,0.03); z-index: 0;">01</span>
                    <div
                        style="width: 60px; height: 60px; background: rgba(212, 175, 55, 0.15); border-radius: 18px; display: flex; align-items: center; justify-content: center; margin-bottom: 25px; color: var(--primary-color); font-size: 1.8rem; box-shadow: 0 0 20px rgba(212, 175, 55, 0.2);">
                        <i class="fa-solid fa-microchip"></i>
                    </div>
                    <h3 style="font-size: 1.4rem; margin-bottom: 15px; font-weight: 800; color: var(--black);">HD Print
                        Matrix</h3>
                    <p style="font-size: 1rem; color: var(--text-light); line-height: 1.6; position: relative; z-index: 1;">
                        Industrial-grade molecular bonding ensures your designs never fade, peel, or crack, wash after wash.
                    </p>
                </div>
                <!-- Feature 2 -->
                <div class="glass"
                    style="padding: 40px; border-radius: 30px; position: relative; overflow: hidden; transition: var(--transition); border: 1px solid rgba(225, 198, 153, 0.2);">
                    <span
                        style="position: absolute; top: 10px; right: 20px; font-size: 4rem; font-weight: 900; color: rgba(255,255,255,0.03); z-index: 0;">02</span>
                    <div
                        style="width: 60px; height: 60px; background: rgba(225, 198, 153, 0.15); border-radius: 18px; display: flex; align-items: center; justify-content: center; margin-bottom: 25px; color: var(--secondary-color); font-size: 1.8rem; box-shadow: 0 0 20px rgba(225, 198, 153, 0.2);">
                        <i class="fa-solid fa-leaf"></i>
                    </div>
                    <h3 style="font-size: 1.4rem; margin-bottom: 15px; font-weight: 800; color: var(--black);">Premium
                        Cotton</h3>
                    <p style="font-size: 1rem; color: var(--text-light); line-height: 1.6; position: relative; z-index: 1;">
                        100% sustainable, pre-shrunk cotton that's bio-washed for an ultra-soft, luxury skin-feel.</p>
                </div>
                <!-- Feature 3 -->
                <div class="glass"
                    style="padding: 40px; border-radius: 30px; position: relative; overflow: hidden; transition: var(--transition); border: 1px solid rgba(205, 127, 50, 0.2);">
                    <span
                        style="position: absolute; top: 10px; right: 20px; font-size: 4rem; font-weight: 900; color: rgba(255,255,255,0.03); z-index: 0;">03</span>
                    <div
                        style="width: 60px; height: 60px; background: rgba(205, 127, 50, 0.15); border-radius: 18px; display: flex; align-items: center; justify-content: center; margin-bottom: 25px; color: var(--accent-color); font-size: 1.8rem; box-shadow: 0 0 20px rgba(205, 127, 50, 0.2);">
                        <i class="fa-solid fa-truck-fast"></i>
                    </div>
                    <h3 style="font-size: 1.4rem; margin-bottom: 15px; font-weight: 800; color: var(--black);">Priority
                        Dispatch</h3>
                    <p style="font-size: 1rem; color: var(--text-light); line-height: 1.6; position: relative; z-index: 1;">
                        Lightning-fast 48-hour order processing with real-time end-to-end tracking across India.</p>
                </div>
                <!-- Feature 4 -->
                <div class="glass"
                    style="padding: 40px; border-radius: 30px; position: relative; overflow: hidden; transition: var(--transition); border: 1px solid rgba(16, 185, 129, 0.2);">
                    <span
                        style="position: absolute; top: 10px; right: 20px; font-size: 4rem; font-weight: 900; color: rgba(255,255,255,0.03); z-index: 0;">04</span>
                    <div
                        style="width: 60px; height: 60px; background: rgba(16, 185, 129, 0.15); border-radius: 18px; display: flex; align-items: center; justify-content: center; margin-bottom: 25px; color: #10b981; font-size: 1.8rem; box-shadow: 0 0 20px rgba(16, 185, 129, 0.2);">
                        <i class="fa-solid fa-clipboard-check"></i>
                    </div>
                    <h3 style="font-size: 1.4rem; margin-bottom: 15px; font-weight: 800; color: var(--black);">12-Point QC
                    </h3>
                    <p style="font-size: 1rem; color: var(--text-light); line-height: 1.6; position: relative; z-index: 1;">
                        Every single garment undergoes a rigorous 12-point quality check before it leaves our facility.</p>
                </div>
                <!-- Feature 5 -->
                <div class="glass"
                    style="padding: 40px; border-radius: 30px; position: relative; overflow: hidden; transition: var(--transition); border: 1px solid rgba(245, 158, 11, 0.2);">
                    <span
                        style="position: absolute; top: 10px; right: 20px; font-size: 4rem; font-weight: 900; color: rgba(255,255,255,0.03); z-index: 0;">05</span>
                    <div
                        style="width: 60px; height: 60px; background: rgba(245, 158, 11, 0.15); border-radius: 18px; display: flex; align-items: center; justify-content: center; margin-bottom: 25px; color: #f59e0b; font-size: 1.8rem; box-shadow: 0 0 20px rgba(245, 158, 11, 0.2);">
                        <i class="fa-solid fa-rotate"></i>
                    </div>
                    <h3 style="font-size: 1.4rem; margin-bottom: 15px; font-weight: 800; color: var(--black);">Easy
                        Exchanges</h3>
                    <p style="font-size: 1rem; color: var(--text-light); line-height: 1.6; position: relative; z-index: 1;">
                        Not the perfect fit? We offer 7-day exchanges on catalog items. <span
                            style="color: var(--accent-color); font-size: 0.85rem; display: block; margin-top: 5px;">*Excludes
                            customized products.</span></p>
                </div>
                <!-- Feature 6 -->
                <div class="glass"
                    style="padding: 40px; border-radius: 30px; position: relative; overflow: hidden; transition: var(--transition); border: 1px solid rgba(255, 255, 255, 0.1);">
                    <span
                        style="position: absolute; top: 10px; right: 20px; font-size: 4rem; font-weight: 900; color: rgba(255,255,255,0.03); z-index: 0;">06</span>
                    <div
                        style="width: 60px; height: 60px; background: rgba(255, 255, 255, 0.05); border-radius: 18px; display: flex; align-items: center; justify-content: center; margin-bottom: 25px; color: var(--black); font-size: 1.8rem; box-shadow: 0 0 20px rgba(255, 255, 255, 0.1);">
                        <i class="fa-solid fa-lock"></i>
                    </div>
                    <h3 style="font-size: 1.4rem; margin-bottom: 15px; font-weight: 800;">Secure Node Pay</h3>
                    <p style="font-size: 1rem; color: var(--text-light); line-height: 1.6; position: relative; z-index: 1;">
                        256-bit encrypted UPI & Card payments for a safe and seamless checkout experience.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="categories-grid">
                @foreach ($categories as $cat)
                    <div class="category-card" onclick="window.location.href='{{ route('collection.show', $cat->slug) }}'"
                    ...
                    <div class="product-card" onclick="window.location.href='{{ route('products.show', $product->slug) }}'"
                        ...
                        <div class="product-info">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <span class="btn btn-primary" style="padding: 5px 15px; font-size: 0.8rem;">Shop
                                    Now</span>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section reveal"
        style="padding: 100px 0; background: var(--bg-color); position: relative; overflow: hidden;">
        <div
            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 100%; height: 100%; background: radial-gradient(circle, rgba(212, 175, 55, 0.1) 0%, transparent 70%);">
        </div>
        ...
        <div class="container">
            ...
            <div class="bento-grid">
                <div class="bento-item large" onclick="window.location.href='{{ route('products.index') }}'">
                    <img src="https://images.unsplash.com/photo-1558191053-8edcb01e1da3?auto=format&fit=crop&w=800&q=80"
                        alt="Street Edit">
                ...
                <div class="bento-item wide" onclick="window.location.href='{{ route('products.index') }}'">
                    <img src="https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?auto=format&fit=crop&w=800&q=80"
                        alt="Corporate Polos">
    ...
    <section class="section testimonials">
        <div class="container">
            <div class="section-title">
                <h2 style="color: var(--black);">Hear from our Fam</h2>
            </div>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
                @forelse($testimonials as $t)
                    <div class="testimonial-card">
                        <div style="display: flex; gap: 5px; color: var(--accent-color); margin-bottom: 20px; font-size: 0.9rem;">
                            @for ($i = 0; $i < $t->rating; $i++)
                                <i class="fa-solid fa-star"></i>
                            @endfor
                        </div>
                        <p style="font-style: italic; color: var(--text-light); line-height: 1.8; font-size: 1.1rem; margin-bottom: 0;">"{{ $t->content }}"</p>
                        <div style="margin-top: 25px; font-weight: 800; color: var(--black); font-size: 1rem; display: flex; align-items: center; gap: 10px;">
                            <div style="width: 30px; height: 2px; background: var(--accent-color);"></div>
                            {{ $t->user_name }}
                        </div>
                    </div>
                @empty
    ...
    <section class="section" style="background: var(--bg-alt); position: relative;">
        <div class="container">
            <div style="display: flex; align-items: center; gap: 60px; flex-wrap: wrap;" class="flex-responsive">
                <div style="flex: 1; min-width: 300px;" class="mobile-100">
                    <h2 style="font-size: 2.5rem; margin-bottom: 20px;">Corporate & Bulk Orders</h2>
                    <p style="font-size: 1.1rem; color: var(--text-light); margin-bottom: 30px;">Planning an event or need
                        branded apparel for your team? Tunicart offers premium bulk printing services with massive discounts
                ...
                <div class="glass mobile-100" style="flex: 1; min-width: 350px; padding: 40px; border-radius: 20px;">
                    <h3 style="margin-bottom: 25px; color: var(--black);">Get a Bulk Quote</h3>
                    <form action="{{ route('contact.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="subject" value="Enterprise Order Query">
                        <div style="margin-bottom: 15px;">
                            <input type="text" name="name" placeholder="Contact Person Name"
                                style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: var(--black);"
                                required>
                        </div>
                        <div style="margin-bottom: 15px;">
                        ...
                        <div style="margin-bottom: 20px;">
                            <textarea name="message" placeholder="Tell us about your bulk requirement (Qty, Style, etc.)..."
                                style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: var(--black); height: 100px; font-family: inherit;"
                                required></textarea>
                        </div>
            ...
            <div style="max-width: 800px; margin: 0 auto;">
                <div class="faq-item">
                    ...
                    <div class="faq-content">
                        <p style="padding: 20px;">Our prints are high-quality DTG/Screen prints designed to last for 50+
                            washes without cracking or fading, provided you follow the wash-care instructions.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header" onclick="toggleFaq(this)">
                    ...
                    <div class="faq-content">
                        <p style="padding: 20px;">Yes, we offer Cash on Delivery across most pin codes in India. However,
                            for custom printed orders, we may require a partial advance for security.</p>
                    </div>
                </div>
                <div style="text-align: center; margin-top: 30px;">
                    <a href="{{ route('faq') }}"
                        style="font-weight: 700; display: inline-flex; align-items: center; gap:
                        10px;">
    ...
    <section class="section" style="background: var(--bg-color);">
        <div class="container mobile-px-20"
            ...
            <p style="color: var(--text-light); margin-bottom: 30px;">Get exclusive deals, early access to new drops, and
                more.</p>
            <form style="display: flex; gap: 10px; max-width: 500px; margin: 0 auto; flex-wrap: wrap;">
                <input type="email" placeholder="Enter your email"
                    style="flex: 1; padding: 15px; border-radius: 10px; border: 1px solid var(--glass-border); background: rgba(255,255,255,0.05); color: var(--black); min-width: 250px;">
