    ...
    <div class="container">
        <div style="display: flex; gap: 50px; flex-wrap: wrap;">
            ...
            <div style="flex: 1; min-width: 300px;">
                <div class="product-image" style="height: 500px; border-radius: 20px;">
            ...
            <div style="flex: 1; min-width: 300px;">
                ...
                <form action="{{ route('cart.add', $product->id) }}" method="POST" enctype="multipart/form-data" class="custom-form">
                    @csrf
                    <h3 style="margin-bottom: 20px;">Customize Your T-Shirt</h3>
                    
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; margin-bottom: 10px; font-weight: 600;">Front Design</label>
                            <div class="upload-box" onclick="document.getElementById('front_image').click()">
                                <i class="fa-solid fa-cloud-arrow-up" style="font-size: 1.5rem; color: var(--primary-color);"></i>
                                <p style="font-size: 0.8rem; margin-top: 5px;">Upload Front</p>
                                <input type="file" name="front_image" id="front_image" style="display: none;" onchange="previewFile(this, 'front-preview')">
                            </div>
                            <div id="front-preview" style="margin-top: 10px; display: none;">
                                <img src="" style="width: 100%; border-radius: 10px;">
                            </div>
                        </div>
                        <div>
                            <label style="display: block; margin-bottom: 10px; font-weight: 600;">Back Design</label>
                            <div class="upload-box" onclick="document.getElementById('back_image').click()">
                                <i class="fa-solid fa-cloud-arrow-up" style="font-size: 1.5rem; color: var(--primary-color);"></i>
                                <p style="font-size: 0.8rem; margin-top: 5px;">Upload Back</p>
                                <input type="file" name="back_image" id="back_image" style="display: none;" onchange="previewFile(this, 'back-preview')">
                            </div>
                            <div id="back-preview" style="margin-top: 10px; display: none;">
                                <img src="" style="width: 100%; border-radius: 10px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 10px; font-weight: 600;">Customization Notes</label>
                        <textarea name="notes" placeholder="Any specific instructions?" style="width: 100%; padding: 15px; border-radius: 10px; border: 1px solid #ddd; height: 100px; font-family: inherit;"></textarea>
                    </div>

                    <div style="display: flex; gap: 20px; align-items: center;">
                        <div style="display: flex; align-items: center; border: 1px solid #ddd; border-radius: 10px; padding: 5px 15px;">
                            <span style="margin-right: 15px; font-weight: 600;">Qty</span>
                            <input type="number" name="quantity" value="1" min="1" style="width: 50px; border: none; font-size: 1.1rem; font-weight: 700; text-align: center;">
                        </div>
